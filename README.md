...
│   └── retrospectiva.md
│
├── Tasques/                     # Carpetes individuals per cada tasca
│   ├── T01_DRP_Cas_Client/
│   ├── T02_DRP_Cas_Practic/
│   ├── T03_Imatges_Sistema/
│   ├── T04_Acces_Remot_Intro/
│   ├── T05_SSH/
│   ├── T06_RDP/
│   ├── T07_Assistencia_Remota/
│   ├── T08_Auditoria_Servidors/
│   ├── T09_Servidor_NFS/
│   ├── T10_Servidor_CUPS/
│   ├── T11_Intro_Figma/
│   ├── T12_Fonaments_Web/
│   ├── T13_Ecommerce_Figma/
│   ├── T14_Sostenibilitat_Escrita/
│   └── T15_Circularitat/
│
└── Productes/                   # Productes finals i avaluacions
